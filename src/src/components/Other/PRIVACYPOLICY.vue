    ...
    <div>
        ...
        <div class="other">
            <div class="other_main">
                ...
                <p><span>1. Definitions used in this Policy</span></p>
                
                <p><span>2. Data protection principles we follow</span></p>
                
                <p><span>3. What rights do you have regarding your Personal Data</span></p>
                
                <p><span>4. What Personal Data we gather about you</span></p>
                
                <p><span>5. How we use your Personal Data</span></p>
                
                <p><span>6. Who else has access to your Personal Data</span></p>
                
                <p><span>7. How we secure your data</span></p>
                
                <p><span>8. Information about cookies</span></p>
                
                <p><span>9. Contact information</span></p>
                
                <H2>DEFINITIONS</H2>
                <p><span>Personal Data</span> – any information relating to an identified or identifiable natural person.</p>
                <p><span>Processing</span> – any operation or set of operations which is performed on Personal Data or on sets of Personal Data.</p>
                <p><span>Data subject</span> – a natural person whose Personal Data is being Processed.</p>
                <p><span>Child</span> – a natural person under 16 years of age.</p>
                <p><span>We/us</span> (either capitalized or not) –</p>
                
                <H2>DATA PROTECTION PRINCIPLES</H2>
                <p><span>We promise to follow the following data protection principles:</span></p>
                <p>Processing is lawful, fair, transparent. Our Processing activities have lawful grounds. We always consider your rights before Processing Personal Data. We will provide you information regarding Processing upon request.</p>
                ...
                <p><span>The Data Subject has the following rights:</span></p>
                ...
                <p>Right to object to processing – meaning in certain cases you have the right to object to Processing of your Personal Data, for example in the case of direct marketing.</p>
                ...
                <p>Right for the help of supervisory authority – meaning you have the right for the help of a supervisory authority and the right for other legal remedies such as claiming damages.</p>
                <p>Right to withdraw consent – you have the right withdraw any given consent for Processing of your Personal Data.</p>
                
                <H2>DATA WE GATHER</H2>
                <p><span>Information you have provided us with</span></p>
                <p>This might be your e-mail address, name, billing address, home address etc – mainly information that is necessary for delivering you a product/service or to enhance your customer experience with us. We save the information you provide us with in order for you to comment or perform other activities on the website. This information includes, for example, your name and e-mail address.</p>
                
                <p><span>Information automatically collected about you</span></p>
                <p>This includes information that is automatically stored by cookies and other session tools. For example, your shopping cart information, your IP address, your shopping history (if there is any) etc. This information is used to improve your customer experience. When you use our services or look at the contents of our website, your activities may be logged.</p>
                
                <p><span>Information from our partners</span></p>
                <p>We gather information from our trusted partners with confirmation that they have legal grounds to share that information with us. This is either information you have provided them directly with or that they have gathered about you on other legal grounds.</p>
                
                <p><span>Publicly available information</span></p>
                <p>We might gather information about you that is publicly available.</p>
                
                <H2>HOW WE USE YOUR PERSONAL DATA</H2>
                <p>We use your Personal Data in order to:</p>
                
                <p>provide our service to you. This includes for example registering your account; providing you with other products and services that you have requested; providing you with promotional items at your request and communicating with you in relation to those products and services; communicating and interacting with you; and notifying you of changes to any services.</p>
                ...
                <p>to administer and analyse our client base (purchasing behaviour and history) in order to improve the quality, variety, and availability of products/ services offered/provided;</p>
                ...
                <p>Functionality cookies – these cookies provide functionality that makes using our service more convenient and makes providing more personalised features possible. For example, they might remember your name and e-mail in comment forms so you don’t have to re-enter this information next time when commenting.</p>
                <p>Analytics cookies – these cookies are used to track the use and performance of our website and services</p>
                <p>Advertising cookies – these cookies are used to deliver advertisements that are relevant to you and to your interests. In addition, they are used to limit the number of times you see an advertisement. They are usually placed to the website by advertising networks with the website operator’s permission. These cookies remember that you have visited a website and this information is shared with other organisations such as advertisers. Often targeting or advertising cookies will be linked to site functionality provided by the other organisation.</p>
                <p>You can remove cookies stored in your computer via your browser settings. Alternatively, you can control some 3rd party cookies by using a privacy enhancement platform such as optout.aboutads.info or youronlinechoices.com. For more information about cookies, visit allaboutcookies.org.</p>
                ...
                <p>admin@metaverse-dao.io</p>
                
                <H2>CHANGES TO THIS PRIVACY POLICY</H2>
                <p>We reserve the right to make change to this Privacy Policy.</p>
                <p><span>Last modification was made – 11/10/21</span></p>
            </div>
        </div>
...
import OtherHeader from '@/components/Header/OtherHeader.vue'
import OtherFooter from '@/components/Footer/OtherFooter.vue'

  export default {
    components: {OtherHeader,OtherFooter},
    data() {
      return {
      }
    },
